...
import org.kie.kogito.research.application.api.events.ModelExecuteEvent;
...
public class PredictionExecuteEvent extends ModelExecuteEvent<PredictionId, PredictionMessage> implements PredictionEvent {
    public PredictionExecuteEvent(RequestId requestId, PredictionId modelId, PredictionMessage payload) {
