...
import org.kie.kogito.research.application.api.events.ModelResponseEvent;
...
public class PredictionResponseEvent  extends ModelResponseEvent<PredictionId, PredictionMessage> implements PredictionEvent {

    public PredictionResponseEvent(RequestId requestId, PredictionId modelId, PredictionMessage payload) {
