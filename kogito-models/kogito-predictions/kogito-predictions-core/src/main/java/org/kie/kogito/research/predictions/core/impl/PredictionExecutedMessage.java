...
import org.kie.kogito.research.application.api.messages.ModelExecutedMessage;
...
public class PredictionExecutedMessage extends ModelExecutedMessage<PredictionId> implements PredictionMessage {
    public PredictionExecutedMessage(RequestId requestId, PredictionId modelId) {
