...
public class PredictionExecuteMessage extends ModelExecutedMessage<PredictionId> implements PredictionMessage {
    public PredictionExecuteMessage(RequestId requestId, PredictionId modelId) {
