...
public abstract class AbstractProcessInstanceFactory {
    ...
    protected final ProcessId processId;

    protected AbstractProcessInstanceFactory(String processId) {
        this.processId = SimpleProcessId.fromString(processId);
    }

    public abstract AbstractProcessInstanceImpl getProcessInstanceImpl(ProcessInstanceMessageBus messageBus);
