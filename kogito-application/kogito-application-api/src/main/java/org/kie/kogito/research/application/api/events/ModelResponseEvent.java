...
public class ModelResponseEvent<T extends ModelId, E extends ModelMessage<T>> extends AbstractModelEvent<T, E> implements Response {

    private final RequestId requestId;

    public ModelResponseEvent(RequestId requestId, T modelId, E payload) {
