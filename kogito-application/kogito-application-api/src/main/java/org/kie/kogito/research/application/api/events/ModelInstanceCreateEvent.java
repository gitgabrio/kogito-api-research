...
public class ModelInstanceCreateEvent<T extends ModelId, E extends ModelInstanceId, U extends InstanceMessage<T, E>> extends AbstractModelInstanceEvent<T, E, U> implements Request  {

    private final RequestId requestId;

    protected ModelInstanceCreateEvent(RequestId requestId, T modelId, E modelInstanceId, U payload) {
