...
public class ModelNoSuchMessage<T extends ModelId> extends AbstractModelMessage<T> implements Response {
    protected ModelNoSuchMessage() {
    }

    public ModelNoSuchMessage(RequestId requestId, T modelId) {
