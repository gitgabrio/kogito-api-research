...
public interface ModelInstanceEvent<T extends ModelId, E extends ModelInstanceId, U extends InstanceMessage<T, E>> extends ModelEvent<T, U> {

    E getModelInstanceId();
}
