...
public class ModelExecutedEvent<T extends ModelId, E extends ModelMessage<T>> extends ModelResponseEvent<T, E> implements ModelEvent<T, E> {


    public ModelExecutedEvent(RequestId requestId, T modelId, E payload) {
