...
public class ModelExecuteEvent<T extends ModelId, E extends ModelMessage<T>> extends ModelRequestEvent<T, E> {

    public ModelExecuteEvent(RequestId requestId, T modelId, E payload) {
