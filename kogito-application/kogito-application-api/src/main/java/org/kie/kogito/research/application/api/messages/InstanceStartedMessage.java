...
public class InstanceStartedMessage<T extends ModelId, E extends ModelInstanceId> extends AbstractInstanceMessage<T, E> implements Response {


    protected InstanceStartedMessage() {
    }

    protected InstanceStartedMessage(RequestId requestId, T modelId, E modelInstanceId) {
