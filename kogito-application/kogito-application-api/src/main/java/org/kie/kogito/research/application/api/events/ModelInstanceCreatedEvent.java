...
public class ModelInstanceCreatedEvent<T extends ModelId, E extends ModelInstanceId, U extends InstanceMessage<T, E>> extends AbstractModelInstanceEvent<T, E, U> implements Response {

    private final RequestId requestId;

    protected ModelInstanceCreatedEvent(RequestId requestId, T modelId, E modelInstanceId, U payload) {
