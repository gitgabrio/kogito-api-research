...
public class ModelExecutedMessage<T extends ModelId> extends AbstractModelMessage<T> implements Response {

    public ModelExecutedMessage(RequestId requestId, T modelId) {
