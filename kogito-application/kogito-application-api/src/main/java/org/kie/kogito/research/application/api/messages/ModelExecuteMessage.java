...
public class ModelExecuteMessage<T extends ModelId> extends AbstractModelMessage<T> implements Request {

    public ModelExecuteMessage(RequestId requestId, T modelId) {
