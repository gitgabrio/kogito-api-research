...
public class ModelNoExecutorMessage<T extends ModelId> extends AbstractModelMessage<T> implements Response {
    protected ModelNoExecutorMessage() {
    }

    public ModelNoExecutorMessage(RequestId requestId, T modelId) {
