...
public class InstanceCreatedMessage<T extends ModelId, E extends ModelInstanceId> extends AbstractInstanceMessage<T, E> implements Response {
    protected InstanceCreatedMessage() {
    }

    protected InstanceCreatedMessage(RequestId requestId, T modelId, E modelInstanceId) {
