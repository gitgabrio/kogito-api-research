...
public class InstanceStartMessage<T extends ModelId, E extends ModelInstanceId> extends AbstractInstanceMessage<T, E> implements Request {

    protected InstanceStartMessage() {
    }

    protected InstanceStartMessage(RequestId requestId, T modelId, E modelInstanceId) {
