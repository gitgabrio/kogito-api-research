...
public class ModelInstanceStartEvent<T extends ModelId, E extends ModelInstanceId, U extends InstanceMessage<T, E>> extends AbstractModelInstanceEvent<T, E, U> implements Request  {

    private final RequestId requestId;

    protected ModelInstanceStartEvent(RequestId requestId, T modelId, E modelInstanceId, U payload) {
